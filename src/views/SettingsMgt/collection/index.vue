    ...
    <el-row :gutter="20">
      ...
      <el-col :span="24" :xs="24">
        ...
        <el-table v-loading="loading" :data="userList">
          ...
          <el-table-column label="发布人" align="center" key="nickName3" prop="nickName" v-if="columns[2].visible" :show-overflow-tooltip="true" />
          <el-table-column label="更新状态" align="center" key="deptName4" prop="dept.deptName" v-if="columns[3].visible" :show-overflow-tooltip="true" />
          <el-table-column label="最后更新时间" align="center" key="deptName5" prop="dept.deptName" v-if="columns[3].visible" :show-overflow-tooltip="true" />
        </el-table>
